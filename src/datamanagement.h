...
public:
    ...
    int saveTile(unsigned char *p, string outFileName, long sx, long sy, long sz, int dataType);
    ...
    int getData(utility::string_t server, utility::string_t uuid, utility::string_t dataName, long xoff, long yoff, long zoff, long sx, long sy, long sz, string outFileName);
};
