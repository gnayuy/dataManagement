...
// g++ -std=c++11 -o basic-http-client basic-http-client.cpp -L/usr/local/lib -lcpprest -lboost_system -lboost_chrono -lboost_thread -lboost_random -lboost_regex -lssl -lcrypto
...
int main(int argc, char* argv[])
{
    ...
    std::cout << L"Calling UploadFileToHttpServerAsync..." << std::endl;
    UploadFileToHttpServerAsync().wait();
